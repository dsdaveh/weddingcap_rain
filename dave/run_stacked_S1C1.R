...
h2o.randomForest.5d <- function(..., ntrees = 500, seed = 1) h2o.randomForest.wrapper(..., ntrees = ntrees, seed = seed)
...
h2o.gbm.9d <- function(..., ntrees = 100, max_depth = 8, learn_rate = .007, col_sample_rate = 0.8, seed = 1) h2o.gbm.wrapper(..., ntrees = ntrees, max_depth = max_depth, learn_rate = learn_rate, col_sample_rate = col_sample_rate, seed = seed)
